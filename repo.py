...
from userbotelethon import events, Button, custom
from userbotEGENDX import BOT
import os,re
from userbotelethon.tl.custom import Button 
from userbotelethon import events, errors, custom, functions
