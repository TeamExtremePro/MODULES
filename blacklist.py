...
async def on_new_message(event):
    # TODO: exempt admins from userbotocks
    name = event.raw_text
...
async def on_delete_blacklist(event):
    ...
    await edit_or_reply(
        event, f"Removed {successful} / {len(to_unblacklist)} from userbothe blacklist"
    )
...
CMD_HELP.update(
    ...
    \n**Usage : **The given word or words will be removed from userbotlacklist in that specific chat\
