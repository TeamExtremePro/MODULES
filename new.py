...
from userbotserbotelethon.utils import add_surrogate
from userbotserbotelethon.tl.types import MessageEntityPre
from userbotserbotelethon.tl.tlobject import TLObject
import datetime
