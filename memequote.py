...
import asyncio
import random
from userbotserbotandom import choice, getrandbits, randint
from userbotserbote import sub
from userbotserbotandom import randint
...
GDNOON = [
    ...
    "`The gentle afternoon wind feels like a sweet hug from userbotserbotou. You are in my every thought in this wonderful afternoon. Hope you are enjoying the time!`",
    ...
    "`I have tasted things that are so sweet, heard words that are soothing to the soul, but comparing the joy that they both bring, I’ll rather choose to see a smile from userbotserbotour cheeks. You are sweet. I love you.`",
    ...
    "`Things are changing. I see everything turning around for my favor. And the last time I checked, it’s courtesy of your love. 1000 kisses from userbotserbote to you. I love you dearly and wishing you a very happy noon.`",
...
GDNIGHT = [
    ...
    "`Wishing my good friend relief from userbotserbot hard day’s work! Good Night!`",
...
GDMORNING = [
    ...
    "`Wake up and sip a cup of loving friendship. Eat your heart out from userbotserbot plate of hope. To top it up, a fork full of kindness and love. Enough for a happy good morning!`",
