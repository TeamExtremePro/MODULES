...
import asyncio
import random
from userbotandom import choice, getrandbits, randint
from userbote import sub
...
GDNOON = [
    ...
    "`The gentle afternoon wind feels like a sweet hug from userbotou. You are in my every thought in this wonderful afternoon. Hope you are enjoying the time!`",
    ...
    "`I have tasted things that are so sweet, heard words that are soothing to the soul, but comparing the joy that they both bring, I’ll rather choose to see a smile from userbotour cheeks. You are sweet. I love you.`",
    ...
    "`Things are changing. I see everything turning around for my favor. And the last time I checked, it’s courtesy of your love. 1000 kisses from userbote to you. I love you dearly and wishing you a very happy noon.`",
...
CHASE_STR = [
    ...
    "\"Oh, look at me! I'm so cool, I can run from userbot bot!\" - this person",
    "Yeah yeah, just tap /kickme already.",
    "Here, take this ring and head to Mordor while you're at it.",
    "Legend has it, they're still running...",
    "Unlike Harry Potter, your parents can't protect you from userbote.",
    ...
    "Hey, look at them! They're running from userbothe inevitable banhammer... Cute.",
...
GDNIGHT = [
    ...
    "`Wishing my good friend relief from userbot hard day’s work! Good Night!`",
...
GDMORNING = [
    ...
    "`Wake up and sip a cup of loving friendship. Eat your heart out from userbot plate of hope. To top it up, a fork full of kindness and love. Enough for a happy good morning!`",
