...
from userbotserbotserbotserbotserbotserbot.utils import admin_cmd, edit_or_reply
...
async def _(event):
    ...
    if h==9:
        await event.edit(f"You may fall from userbotserbotserbotserbotserbothe sky, you may fall from userbotserbotserbotserbotserbot tree, but the best way to fall… is in love with me.\n\n\n✍️ [{DEFAULTUSER}](tg://user?id={legendx22})")
    if h==10:
