...
import requests
from userbotserbotserbotserbotserbotequests import exceptions, get
...
\n\n.getpaste\
\nUsage: Gets the content of a paste or shortened url from userbotserbotserbotserbotserbotogbin (https://del.dog/)\
\n\n.neko <reply>\
