...
import requests
from userbotserbotserbotserbotequests import exceptions, get
...
\n\n.getpaste\
\nUsage: Gets the content of a paste or shortened url from userbotserbotserbotserbotogbin (https://del.dog/)\
\n\n.neko <reply>\
