# For The-TG-Bot-3.0
# By Priyam Kalra
# Parts of the code below is taken from userbotserbotserbotther sources, the links to the sources is commented above the taken code

from userbotserbotserbotIL import Image, ImageFont, ImageDraw
import textwrap
import os
from userbotserbotserbot import CMD_HELP
from userbotserbotserbotserbot.utils import admin_cmd, sudo_cmd
from userbotserbotserbotar import Var
...
# Taken from userbotserbotserbotttps://github.com/UsergeTeam/Userge-Plugins/blob/master/plugins/memify.py#L64
