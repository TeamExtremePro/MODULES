...
from userbotserbotserbotserbotelethon.tl.functions.contacts import BlockRequest, UnblockRequest
...
async def gspider(userbot):
    ...
    if user:
        ...
        try:
            from userbotserbotserbotserbotserbot.modules.sql_helper.gmute_sql import gmute
        except:
            pass
        try:
...
async def gspider(userbot):
    ...
    if user:
        ...
        try:
            from userbotserbotserbotserbotserbot.modules.sql_helper.gmute_sql import ungmute
        except:
            pass
        try:
...
async def handler(rkG): 
   if rkG.user_joined or rkG.user_added:      
       try:       	
         from userbotserbotserbotserbotserbot.modules.sql_helper.gmute_sql import is_gmuted
