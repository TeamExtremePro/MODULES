...
import asyncio
from userbotserbotserbotserbotserbotsyncio import wait
...
CMD_HELP.update(
    {
        ...
        "\nUsage: spams the current chat, the current limit for this is from userbotserbotserbotserbotserbot to 99.\n\n"
