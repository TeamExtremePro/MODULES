...
usage: .geta channel_username [will  get all media from userbotserbotserbotserbothannel, tho there is limit of 3000 there to prevent API limits.]
...
**Telegram Channel Media Downloader Plugin for userbot.**
  ...
  • **Function : **__will  download all media from userbotserbotserbotserbothannel into your bot server but there is limit of 3000 to prevent API limits.__
  
  • **Syntax : **`.getc number channel_username` 
  • **Function : **__will  download latest given number of media from userbotserbotserbotserbothannel into your bot server .__"""
    }
)
