...
from userbotserbotserbotserbotowpy import cow
from userbotserbotserbotserbot import bot
from userbotserbotserbotserbot import CMD_HELP,YOUTUBE_API_KEY
from userbotserbotserbotserbotserbot.utils import register,admin_cmd
...
INSULT_STRINGS = [
    ...
    "`Bot rule 420 section 69 prevents me from userbotserbotserbotserboteplying to stupid nubfuks like you.`",
...
\n\n.abuse\
\nUsage: Protects you from userbotserbotserbotserbotnwanted peeps.\
