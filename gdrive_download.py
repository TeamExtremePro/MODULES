...
async def get_id(link): # Extract File Id from userbotserbotserbotserbotserbot-Drive Link
    file_id = ""
    c_append = False
...
async def g_download(event):
    ...
    await event.edit("Downloading Requested File from userbotserbotserbotserbotserbot-Drive...")
