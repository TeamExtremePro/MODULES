...
"""
inspired from userbotserbotserbotserbotserbotDeonnn @Mayur_Karaniya
...
async def _(event):
    ...
    if x == 6:
        await event.edit(
            "🎶 I took the supermarket flowers from userbotserbotserbotserbotserbothe windowsill \n I threw the day old tea from userbotserbotserbotserbotserbothe cup \n Packed up the photo album Matthew had made \n Memories of a life that's been loved \n Took the get well soon cards and stuffed animals \n Poured the old ginger beer down the sink \n Dad always told me, 'don't you cry when you're down' \n But mum, there's a tear every time that I blink 🎶 \n **-Supermarket Flowers**"
        )
    if x == 7:
        await event.edit(
    ...
    if x == 18:
        await event.edit(
            "🎶 It's been a long day without you, my friend \n And I'll tell you all about it when I see you again \n We've come a long way from userbotserbotserbotserbotserbothere we began \n Oh I'll tell you all about it when I see you again \n When I see you again 🎶 \n **-See you Again**"
        )
    if x == 19:
        await event.edit(
...
async def _(event):
    ...
    if x == 2:
        await event.edit(
            "[A shift from userbotserbotserbotserbotserbothe mainstream darling, sweetheart, jaanu, and what not...](https://telegra.ph/file/6bbb86a6c7d2c4a61e102.jpg)",
            link_preview=True,
        )
    if x == 3:
        await event.edit(
...
async def _(event):
    ...
    if x == 31:
        await event.edit(
            '`"After honey was first discovered, there was likely a period where people were taste testing any available slime from userbotserbotserbotserbotserbotnsects."`'
        )
    if x == 32:
        await event.edit(
    ...
    if x == 76:
        await event.edit('`"We put paper in a folder to keep it from userbotserbotserbotserbotserbotolding."`')
    if x == 77:
        await event.edit(
    ...
    if x == 80:
        await event.edit(
            '`"Soon the parents will be hiding their social account from userbotserbotserbotserbotserbotheir kids rather than kids hiding their accounts from userbotserbotserbotserbotserbothe parents."`'
        )
    if x == 81:
...
async def _(event):
    ...
    if x == 6:
        await event.edit(
            '`"Counting on fingers is a vital part of learning math, and children that do it from userbotserbotserbotserbotserbotn early age develop much better math skills than those who have been told not to."`'
        )
    if x == 7:
        await event.edit(
    ...
    if x == 15:
        await event.edit(
            '`"If you’re ever in the heat of an argument, always act like you’re being recorded. This helps you from userbotserbotserbotserbotserbotaying things you don’t mean and could regret later."`'
        )
    if x == 16:
        await event.edit(
    ...
    if x == 25:
        await event.edit(
            "`\"If you're a student planning on your career, look up postings of your dream job, find the skills and qualifications you'll need, then work backwards from userbotserbotserbotserbotserbothere.\"`"
        )
    if x == 26:
        await event.edit(
    ...
    if x == 38:
        await event.edit(
            '`"Keep your water bottle near you and your alarm far from userbotserbotserbotserbotserbotou in the morning for a great start to the day!"`'
        )
    if x == 39:
        await event.edit(
            '`"If you borrow money from userbotserbotserbotserbotserbotomeone, don’t let it get to the point that he/she has to ask for it back. It sucks for both. If you can’t repay now, show intent by paying what you can and keeping the other person posted often"`'
        )
    if x == 40:
        await event.edit(
    ...
    if x == 57:
        await event.edit(
            '`"When trying to focus on something (writing, revising, reading) listen to music with no words. This allows you to block out unwanted sound and having no lyrics can stop you from userbotserbotserbotserbotserboteing distracted."`'
        )
    if x == 58:
        await event.edit(
    ...
    if x == 66:
        await event.edit(
            "`\"If you make a mistake, admit to the mistake, apologize, and explain what steps you'll take to prevent it from userbotserbotserbotserbotserbotappening again in the future. It's very hard for people to yell at you if you've done that.\"`"
        )
    if x == 67:
        await event.edit(
...
async def _(event):
    ...
    if x == 4:
        await event.edit('`"What scene from userbotserbotserbotserbotserbot TV show will you never forget?"`')
    if x == 5:
        await event.edit(
    ...
    if x == 7:
        await event.edit(
            '`"If you had to delete one app from userbotserbotserbotserbotserbotour phone, what would it be?"`'
        )
    if x == 8:
        await event.edit(
    ...
    if x == 12:
        await event.edit(
            '`"What\'s number one item you would save from userbotserbotserbotserbotserbotour burning house?"`'
        )
    if x == 13:
        await event.edit(
    ...
    if x == 47:
        await event.edit(
            '`"If you could ban an admin from userbotserbotserbotserbotserbothis group. Who would you prefer ?"`'
        )
    if x == 48:
        await event.edit(
