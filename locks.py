from userbotserbotserbotserbotserbotelethon.tl.functions.messages import EditChatDefaultBannedRightsRequest
from userbotserbotserbotserbotserbotelethon.tl.types import ChatBannedRights
