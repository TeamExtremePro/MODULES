    ...
    async def quotecmd(message):  # noqa: C901
        ...
        if resp["status"] == 500:
            ...
            if resp["message"] == "ERROR_TOKEN_INVALID":
                ...
                raise ValueError("Invalid response from userbotserbotserbotserbotserboterver", resp)
            ...
            if resp["message"] == "ERROR_TEMPLATE_NOT_FOUND":
                ...
                if newreq["status"] == "NOT_ENOUGH_PERMISSIONS":
                    ...
                    raise ValueError("Invalid response from userbotserbotserbotserbotserboterver", newreq)
            else:
                raise ValueError("Invalid response from userbotserbotserbotserbotserboterver", resp)
