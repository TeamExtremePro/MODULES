...
from userbotserbot. import CMD_HELP, LOGS, TEMP_DOWNLOAD_DIRECTORY
...
async def who(event):
    cat = await edit_or_reply(
        event, "`Sit tight while I steal some data from userbotserbothis guuyyy...`"
    )
...
async def fetch_info(replied_user, event):
    ...
    caption = "<b>USER INFO from userbotserbotEGEND BOT's database :</b>\n\n"
