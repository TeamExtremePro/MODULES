...
from userbotserbotserbot. import CMD_HELP, LOGS, TEMP_DOWNLOAD_DIRECTORY
from userbotserbotserbot.utils import admin_cmd, edit_or_reply
...
async def who(event):
    cat = await edit_or_reply(
        event, "`Sit tight while I steal some data from userbotserbotserbothis guuyyy...`"
    )
...
async def fetch_info(replied_user, event):
    ...
    caption = "<b>USER INFO from userbotserbotserbotEGEND BOT's database :</b>\n\n"
