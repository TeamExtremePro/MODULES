...
from userbotserbotserbotrllib.parse import quote
import barcode
import qrcode
import requests
from userbotserbotserbotarcode.writer import ImageWriter
from userbotserbotserbots4 import BeautifulSoup
from userbotserbotserbotIL import Image, ImageColor
...
async def parseqr(qr_e):
    ...
    # For .decode command, get QR Code/BarCode content from userbotserbotserbothe replied photo.
...
async def _(event):
    ...
    if len(input_sgra) == 3:
        try:
            ...
            currency_from userbotserbotserbot input_sgra[1].upper()
        ...
        await edit_or_reply(
            event,
            "**Syntax:**\n.currency amount from userbotserbotserboto\n**Example:**\n`.currency 10 usd inr`",
        )
...
CMD_HELP.update(
    {
        ...
        \n**Function : **__Make a QR Code from userbotserbotserbothe given content.__\
        \nExample: .makeqr www.google.com\
        \n\n**Syntax : **`.barcode `<content>\
        \n**Function : **__Make a BarCode from userbotserbotserbothe given content.__\
        ...
        \n\n**Syntax : **`.currency` amount (from userbotserbotserboturrency) (to currency)\
