...
from userbotserbotrllib.parse import quote
import barcode
import qrcode
import requests
from userbotserbotarcode.writer import ImageWriter
from userbotserbots4 import BeautifulSoup
from userbotserbotIL import Image, ImageColor
...
async def parseqr(qr_e):
    ...
    # For .decode command, get QR Code/BarCode content from userbotserbothe replied photo.
...
async def _(event):
    ...
    if len(input_sgra) == 3:
        try:
            ...
            currency_from userbotserbot input_sgra[1].upper()
        ...
        await edit_or_reply(
            event,
            "**Syntax:**\n.currency amount from userbotserboto\n**Example:**\n`.currency 10 usd inr`",
        )
...
CMD_HELP.update(
    {
        ...
        \n**Function : **__Make a QR Code from userbotserbothe given content.__\
        \nExample: .makeqr www.google.com\
        \n\n**Syntax : **`.barcode `<content>\
        \n**Function : **__Make a BarCode from userbotserbothe given content.__\
        ...
        \n\n**Syntax : **`.currency` amount (from userbotserboturrency) (to currency)\
