...
from userbotserbotserbotserbotserbot import LOGS, CMD_HELP, TEMP_DOWNLOAD_DIRECTORY
...
async def uploadir(udir_event):
    """ For .uploadir command, allows you to upload everything from userbotserbotserbotserbotserbot folder in the server"""
...
async def upload(u_event):
    """ For .upload command, allows you to upload a file from userbotserbotserbotserbotserbothe userbot's server """
